...
![jzfs://image.png](jzfs://${TEST_REPO}/${TEST_REF}/${TEST_FILE_NAME})
`;

    const markdownWithReplacedImage = `# README

Text and whatever and hey look at this image:
![jzfs://image.png](${getImageUrl(TEST_REPO, TEST_REF, TEST_FILE_NAME)})
`;
...
Text and whatever and hey look at this image:
![jzfs://image.png](jzfs://${TEST_REPO}/${TEST_REF}/${ADDITIONAL_PATH}/${TEST_FILE_NAME})
`;

    const markdownWithReplacedImage = `# README

Text and whatever and hey look at this image:
![jzfs://image.png](${getImageUrl(
      TEST_REPO,
      TEST_REF,
