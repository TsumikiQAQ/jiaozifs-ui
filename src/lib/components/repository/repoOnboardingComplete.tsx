  ...
  <Container className="complete-card">
    ...
    <Row className="g-0">
      <Col className="d-flex justify-content-center checklist-complete-text">
        <div>
          {`You're JiaoziFS repository is now set up for data versioning. You can branch to create isolated versions of your data, commit changes to create reproducible snapshots, and merge to incorporate your changes in one atomic operation. Visit our`}{" "}
          <a href="https://docs.pando.network/#welcome-to-the-lake" target="_blank">
            docs
          </a>
          {` for more on using JiaoziFS and integrating it with your data ecosystem.`}
        </div>
      </Col>
    </Row>
    <Row>
