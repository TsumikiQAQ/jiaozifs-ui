...
import {Button,Col,Card,Row,Alert,Form,InputGroup,ButtonToolbar,Modal,Spinner,Container} from "react-bootstrap";
...
export const GettingStartedCreateRepoButton = ({text, variant = "success", enabled = false, onClick, creatingRepo, style = {}}) => {
    return (
...
export const GetStarted = ({onCreateSampleRepo, onCreateEmptyRepo, creatingRepo, createRepoError }) => {
    return (
