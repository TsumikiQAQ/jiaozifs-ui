...
const GCPolicy = ({repo}) => {
    ...
    return <div className="mt-3 mb-5">
        ...
        <div>
            ...
            This policy determines for how long objects are kept in the storage after they are deleted in JiaoziFS. <a
            href="https://docs.pando.network" target="_blank">Learn more.</a>
        </div>
        <div className={"mt-3"}>
            {content}
        </div>
