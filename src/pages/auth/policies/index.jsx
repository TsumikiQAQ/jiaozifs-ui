    ...
    return (
        <>
            ...
            {rbac === 'simplified' && <Warning>
                                ...
                                our <a href="https://docs.pando.network">documentation page</a>.
                            </Warning>}
            <div className="auth-learn-more">
                A policy defines the permissions of a user or a group. <a href="https://docs.pando.network" target="_blank" rel="noopener noreferrer">Learn more.</a>
            </div>
